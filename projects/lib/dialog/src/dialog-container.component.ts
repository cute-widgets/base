...
import {CuteDialogStage} from "./dialog-stage.component";
...
export const OPEN_ANIMATION_DURATION = 300;   //150

/** Duration of the closing animation in milliseconds. */
export const CLOSE_ANIMATION_DURATION = 300;  //75

@Component({
    selector: 'cute-dialog-container',
    ...
    imports: [PortalModule, CuteDialogStage]
})
export class CuteDialogContainer extends CdkDialogContainer<CuteDialogConfig> implements OnDestroy {
  ...
  protected _overlayRef: OverlayRef = inject(OverlayRef);
  ...
  constructor() {
    ...
    const dialogConfig: CuteDialogConfig = inject(CuteDialogConfig);
