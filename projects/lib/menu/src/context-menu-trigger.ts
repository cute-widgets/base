...
export class CuteContextMenuTrigger extends CuteMenuTriggerBase implements OnDestroy {
  ...
  @Input({alias: 'cuteContextMenuTriggerFor', required: true})
  ...
  @Input('cuteContextMenuTriggerData')
   ...
   */
  @Input('cuteContextMenuTriggerRestoreFocus')
  override restoreFocus: boolean = true;

  /** Whether the context menu is disabled. */
  @Input({alias: 'cuteContextMenuTriggerDisabled', transform: booleanAttribute})
