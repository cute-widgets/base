 ...
 */
import {isDevMode, QueryList} from '@angular/core';
...
export abstract class TileStyler {
  ...
  setColStyles(tile: CuteGridTile, colIndex: number, percentWidth: number, gutterWidth: number) {
...
export class FixedTileStyler extends TileStyler {
  ...
  override setRowStyles(tile: CuteGridTile, rowIndex: number): void {
