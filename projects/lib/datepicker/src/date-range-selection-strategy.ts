...
export const CUTE_DATE_RANGE_SELECTION_STRATEGY = new InjectionToken<
  CuteDateRangeSelectionStrategy<any>
>('CUTE_DATE_RANGE_SELECTION_STRATEGY');

/** Object that can be provided in order to customize the date range selection behavior. */
export interface CuteDateRangeSelectionStrategy<D> {
  /**
...
@Injectable()
export class DefaultCuteCalendarRangeStrategy<D> implements CuteDateRangeSelectionStrategy<D> {
...
/** @docs-private */
export function CUTE_CALENDAR_RANGE_STRATEGY_PROVIDER_FACTORY(
  parent: CuteDateRangeSelectionStrategy<unknown>,
  adapter: DateAdapter<unknown>,
) {
  return parent || new DefaultCuteCalendarRangeStrategy(adapter);
}

/** @docs-private */
export const CUTE_CALENDAR_RANGE_STRATEGY_PROVIDER: FactoryProvider = {
  provide: CUTE_DATE_RANGE_SELECTION_STRATEGY,
  deps: [[new Optional(), new SkipSelf(), CUTE_DATE_RANGE_SELECTION_STRATEGY], DateAdapter],
  useFactory: CUTE_CALENDAR_RANGE_STRATEGY_PROVIDER_FACTORY,
};
