...
import {
  CuteCalendarBody,
  CuteCalendarCell,
  CuteCalendarUserEvent,
  CuteCalendarCellClassFunction,
} from './calendar-body';
 ...
 */
@Component({
    selector: 'cute-month-view',
    templateUrl: './month-view.html',
    exportAs: 'cuteMonthView',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [CuteCalendarBody]
})
export class CuteMonthView<D> implements AfterContentInit, OnChanges, OnDestroy {
  ...
  private _rangeStrategy = inject<CuteDateRangeSelectionStrategy<D>>(
    CUTE_DATE_RANGE_SELECTION_STRATEGY,
    {optional: true},
  );
  ...
  @Input() activeDrag: CuteCalendarUserEvent<D> | null = null;
   ...
   */
  @Output() readonly dragEnded = new EventEmitter<CuteCalendarUserEvent<DateRange<D> | null>>();

  /** Emits when any date is activated. */
  @Output() readonly activeDateChange: EventEmitter<D> = new EventEmitter<D>();

  /** The body of calendar table */
  @ViewChild(CuteCalendarBody) _cuteCalendarBody: CuteCalendarBody | undefined;
  ...
  _dateSelected(event: CuteCalendarUserEvent<number>) {
   ...
   */
  _updateActiveDate(event: CuteCalendarUserEvent<number>) {
  ...
  _focusActiveCell(movePreview?: boolean) {
    this._cuteCalendarBody?._focusActiveCell(movePreview);
  }

  /** Focuses the active cell after change detection has run and the microtask queue is empty. */
  _focusActiveCellAfterViewChecked() {
    this._cuteCalendarBody?._scheduleFocusActiveCellAfterViewChecked();
  }

  /** Called when the user has activated a new cell and the preview needs to be updated. */
  _previewChanged({event, value: cell}: CuteCalendarUserEvent<CuteCalendarCell<D> | null>) {
   ...
   */
  protected _dragEnded(event: CuteCalendarUserEvent<D | null>) {
  ...
  private _initWeekdays() {
    ...
    let weekdays = longWeekdays.map((long: any, i: string | number) => {
