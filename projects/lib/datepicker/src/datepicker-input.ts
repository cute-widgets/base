...
import {CuteDatepickerInputBase, DateFilterFn, _CuteFormFieldPartial} from './datepicker-input-base';
...
/** @docs-private */
export const CUTE_DATEPICKER_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => CuteDatepickerInput),
  multi: true,
};

/** @docs-private */
export const CUTE_DATEPICKER_VALIDATORS: any = {
...
@Directive({
  ...
  exportAs: 'cuteDatepickerInput',
  standalone: true,
})
export class CuteDatepickerInput<D>
  extends CuteDatepickerInputBase<D | null, D>
  implements CuteDatepickerControl<D | null>, OnDestroy
{
  ...
  @Input('cuteDatepickerFilter')
  get dateFilter(): DateFilterFn<D | null> | undefined { return this._dateFilter; }
  ...
  private _dateFilter: DateFilterFn<D | null> | undefined;
