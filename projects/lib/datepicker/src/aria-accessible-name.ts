...
/**
 * Computes the *expected* ARIA accessible name for an argument element based on [accname-1.2
 ...
 * "Root node" passed to `_computeAriaAccessibleName` or "Current node" as a result of recursion.
 *
...
function _computeAriaAccessibleNameInternal(
  ...
  //  - Does not implement Step 2.A. of accname-1.2: ''' if the current node is hidden and not directly
