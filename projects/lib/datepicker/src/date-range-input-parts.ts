 ...
 */
export const CUTE_DATE_RANGE_INPUT_PARENT = new InjectionToken<CuteDateRangeInputParent<unknown>>(
 ...
 */
@Directive()
abstract class CuteDateRangeInputPartBase<D>
  extends CuteDatepickerInputBase<DateRange<D>>
  implements OnInit, DoCheck
{
  _rangeInput = inject<CuteDateRangeInputParent<D>>(CUTE_DATE_RANGE_INPUT_PARENT);
  ...
  protected override _assignValueProgrammatically(value: D | null, reformat: boolean) {
    ...
    ) as CuteDateRangeInputPartBase<D> | undefined;
...
export class CuteStartDate<D> extends CuteDateRangeInputPartBase<D> {
  ...
  private _startValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
    ...
    return !start || !end || this._dateAdapter.compareDate(start, end) <= 0
      ? null
      : {'cuteStartDateInvalid': {'end': end, 'actual': start}};
  };
...
export class CuteEndDate<D> extends CuteDateRangeInputPartBase<D> {
  ...
  private _endValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
    ...
    return !end || !start || this._dateAdapter.compareDate(end, start) >= 0
      ? null
      : {'cuteEndDateInvalid': {'start': start, 'actual': end}};
  };
  ...
  private _moveCaretToEndOfStartInput() {
    if (this._rangeInput._startInput) {
