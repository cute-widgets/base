 ...
 */
@Component({
    selector: 'cute-multi-year-view',
    templateUrl: './multi-year-view.html',
    exportAs: 'cuteMultiYearView',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [CuteCalendarBody]
})
export class CuteMultiYearView<D> implements AfterContentInit, OnDestroy {
  ...
  _yearSelected(event: CuteCalendarUserEvent<number>) {
  ...
  private _createCellForYear(year: number) {
    ...
    return new CuteCalendarCell(year, yearName, yearName, this._shouldEnableYear(year), cellClasses);
  }
